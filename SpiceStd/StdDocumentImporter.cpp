...
StdEntryPayloadContent parseTypedPayload(
    ...
    case kStdSparcCombinedType:
        return StdSparcPayload{
            ...
            .sparcDelayTicks = reader.read_i16(offset + 0x14U),
            .effectLifetimeTicks = reader.read_i16(offset + 0x16U),
            .durationOrActivationCount = reader.read_i16(offset + 0x18U),
            .childParameterS16 = reader.read_i16(offset + 0x1aU),
            .positionOrOffset = readFloatArray<3U>(reader, offset + 0x1cU),
            .velocityVector = readFloatArray<3U>(reader, offset + 0x28U),
            .spawnCount = reader.read_i16(offset + 0x34U),
            .randomRange = reader.read_i16(offset + 0x36U),
            .spawnMode = reader.read_i16(offset + 0x38U),
            .raw3a = reader.read_i16(offset + 0x3aU),
            .childDivisorOrParameter = StdFloat32{ reader.read_u32(offset + 0x3cU) },
            .childParameters40 = readFloatArray<2U>(reader, offset + 0x40U),
            .vectorMultipliers = readFloatArray<3U>(reader, offset + 0x48U),
            .secondaryVector = readFloatArray<3U>(reader, offset + 0x54U),
            .choices = readSparcChoices(reader, offset + 0x60U),
            .choiceFirstRaw = reader.read_i16(offset + 0x160U),
            .choiceLastRaw = reader.read_i16(offset + 0x162U),
        };
